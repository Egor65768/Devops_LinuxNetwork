...
![linux](./image/image06.png)  

![linux](./image/image07.png)  
...
![linux](./image/image6.jpeg)

Для ws2 

![linux](./image/image7.jpeg)
...
![linux](./image/image8.jpeg)

перезапустим сервис сети и пропингуем

![linux](./image/image9.jpeg)
...
![linux](./image/image10.jpeg)

## Part 4. Сетевой экран

1) Создай файл /etc/firewall.sh, имитирующий фаерволл, на ws1 и ws2:  

![linux](./image/image11.jpeg)  

![linux](./image/image12.jpeg)    
...
![linux](./image/image13.jpeg)  

![linux](./image/image14.jpeg)  
...
![linux](./image/image16.jpeg)  

ws21

![linux](./image/image17.jpeg)  

ws22

![linux](./image/image18.jpeg)  

r1

![linux](./image/image19.jpeg) 

r2

![linux](./image/image20.jpeg)  

Командой ip -4 проверим что адресса машин заданы верно. Так же пропингуем ws22 с ws21 и r1 с ws11

![linux](./image/image21.jpeg)  

![linux](./image/image22.jpeg)  

![linux](./image/image23.jpeg)  

![linux](./image/image24.jpeg)  

![linux](./image/image25.jpeg)  
...
![linux](./image/image35.jpeg)

![linux](./image/image36.jpeg)

![linux](./image/image37.jpeg)

![linux](./image/image38.jpeg)

![linux](./image/image39.jpeg)

Пропингуем с ws11 роутер r2 и покажи на r2, что пинг доходит.

![linux](./image/image40.jpeg)

![linux](./image/image41.jpeg)

### 5.4. Добавление статических маршрутов  

Добавь в роутеры r1 и r2 статические маршруты в файле конфигураций. Пример для r1 маршрута в сетку 10.20.0.0/26:

![linux](./image/image42.jpeg)

![linux](./image/image43.jpeg)

Вызови ip r и покажи таблицы с маршрутами на обоих роутерах. Пример таблицы на r1:

![linux](./image/image44.jpeg)

![linux](./image/image45.jpeg)

Запусти команды на ws11:
ip r list 10.10.0.0/[маска сети] и ip r list 0.0.0.0/0

![linux](./image/image46.jpeg)
...
![linux](./image/image47.jpeg)

вызов и вывод tcpdump для enp0s9 на r1

![linux](./image/image48.jpeg)  
...
![linux](./image/image49.jpeg)  
Пропингуем с ws11 несуществующий IP (например, 10.30.0.111) с помощью команды:    
![linux](./image/image50.jpeg)  
...
![linux](./image/image53.jpeg)  
![linux](./image/image54.jpeg)
![linux](./image/image55.jpeg)   
...
![linux](./image/image58.jpeg)  

перезагружаем службу DHCP  

![linux](./image/image59.jpeg)  

перезагружаем ws11 и вызываем ip a

![linux](./image/image60.jpeg)
...
![linux](./image/image61.jpeg)  

ip WS21 после обновления

![linux](./image/image62.jpeg)  

## Part 7. NAT

В файле /etc/apache2/ports.conf на ws22 и r1 измени строку Listen 80 на Listen 0.0.0.0:80, то есть сделай сервер Apache2 общедоступным:  

![linux](./image/image63.jpeg) 

![linux](./image/image635.jpeg) 

Запустим веб-сервер Apache командой service apache2 start на ws22 и r1:  

![linux](./image/image64.jpeg) 

![linux](./image/image645.jpeg) 
...
![linux](./image/image71.jpeg)

Запустим файл также, как в Части 4

![linux](./image/image72.jpeg)
...
![linux](./image/image73.jpeg)

Показываю что до r1 доходит

![linux](./image/image735.jpeg)

Проверь соединение по TCP для DNAT: для этого с r1 подключиться к серверу Apache на ws22 командой telnet (обращаться по адресу r2 и порту 8080)

![linux](./image/image74.jpeg)
...
![linux](./image/image76.jpeg)

![linux](./image/image77.jpeg)

Воспользуйся Local TCP forwarding с ws21 до ws22, чтобы получить доступ к веб-серверу на ws22 с ws21:

![linux](./image/image78.jpeg)
...
![linux](./image/image80.jpeg)

![linux](./image/image81.jpeg)
